...
/**
 * Purpose:<br>
 * You were at Walmart near your home to make some purchases last weekend.<br>
 * You had so much coins including nickels, dimes, etc and wanted to just use
 * them all for your purchases.<br>
 * A cash register sums up the sales and then computes the change due to
 * you.<br>
 * 
 * <p>
